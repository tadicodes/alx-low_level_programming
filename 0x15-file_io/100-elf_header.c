 ...
 * Description: if file is not ELF file use exit code 98
 */
...
/**
 * print_magic - to print magic numbers
 * @e_ident: pointer to array with ELF magic numbers
...
/**
 * print_data - to print data of ELF header
 * @e_ident: pointer to array with ELF class
 */
 ...
 * @e_type: ELF type
 * @e_ident: pointer to an array with ELF class
 */
 ...
 * @elf: file descripto
 * Description: If file cant be closed use exit code 98
 */
...
/**
 * main - Displays info contained in ELF header at beginning of ELF file
 * @argc: number of arguments given to program
 * @argv: array of pointers to arguments
 * Return: 0 for success
 * Description: If file is not ELF File or
 * For a fail use exit code 98
 */
